...
namespace Archagent.Revit
{
    ...
    ///
    /// Revit loads its own Newtonsoft.Json into the process; an add-in that
    /// brings a second copy is a well-known way to crash Revit or to break
    /// another add-in. This avoids the whole class of problem.
    /// </summary>
