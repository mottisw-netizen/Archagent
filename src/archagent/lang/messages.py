...
ENGLISH: dict[str, str] = {
    ...
    "national_standard": "{element} {parameter} must be at least {value} per {source}",
    "unconfirmed_source_warning": "⚠ UNVERIFIED SOURCE - ",
...
HEBREW: dict[str, str] = {
    ...
    "national_standard": "{parameter} של {element} חייב להיות לפחות {value} לפי {source}",
    "unconfirmed_source_warning": "⚠ מקור לא מאומת - ",
