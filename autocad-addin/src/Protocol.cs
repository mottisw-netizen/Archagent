namespace Archagent.Acad
{
    ...
    /// and from <c>revit-addin/src/Protocol.cs</c> - one contract, every host.
    /// The mock host in <c>archagent.drawing.mock_host</c> is the executable
    /// specification every implementation, including this one, is tested against.
    /// </summary>
